...
namespace RankVectors.Test.com.rankvectors.api
{
    ...
    public sealed class ProjectsApiTests : ApiTestsBase
    {
        ...
        public async Task CreateProjectAsyncTest()
        {
            ...
            var response = await _instance.CreateProjectAsync(createProjectRequest);
        ...
        public async Task DeleteProjectAsyncTest()
        {
            ...
            var response = await _instance.DeleteProjectAsync(projectId);
            var model = response.Ok();
            Assert.IsType<DeleteProject200Response>(model);
        }
