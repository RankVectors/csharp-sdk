...
namespace RankVectors.com.rankvectors.model
{
    ...
    public partial class Error : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varError">Error message</param>
        /// <param name="details">Additional error details</param>
        /// <param name="code">Error code</param>
        /// <param name="name">Error name</param>
        [JsonConstructor]
        public Error(string varError, Option<string?> details = default, Option<string?> code = default, Option<string?> name = default)
        {
            VarError = varError;
        ...
        /* <example>Invalid parameters</example> */
        ...
        /* <example>Name and domain are required</example> */
    ...
    public class ErrorJsonConverter : JsonConverter<Error>
    {
        ...
        public override Error Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class Error.");

            return new Error(varError.Value!, details, code, name);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Error error, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (error.NameOption.IsSet && error.Name == null)
                throw new ArgumentNullException(nameof(error.Name), "Property is required for class Error.");
